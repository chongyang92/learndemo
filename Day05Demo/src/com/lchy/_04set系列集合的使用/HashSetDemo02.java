...
/**
    目标：HashSet集合元素去重复的流程。

    集合和泛型都只能支持引用数据类型。

    1.对于有特性的(?)，Set集合可以直接判断进行去重复。
    ...
    需求：只要对象内容一样，就希望集合认为他们重复了。重写hashCode和equals方法。

    小结：
        如果希望Set集合认为两对象只要内容一样就重复了，必须重写hashCode()和equals方法
 */
public class HashSetDemo02 {
    public static void main(String[] args) {
        ...
        apples.add(a1);
        //apples.add(a1);//此处地址和上一行a1是地址相同，直接判断为重复
        apples.add(a2);
        apples.add(a3);
