...
/**
    ...
    ---------------------------------------------
    应用层： 应用程序（QQ，微信，浏览器）可能用到的协议（HTTP，FTP，SMTP） 通常程序员只需要关心这一层　１代表文本，２代表图片，３代表视频
    ---------------------------------------------
    传输层： TCP/IP协议 - UDP协议 计算机网络工程师需要精通的协议，有些技术我们也需要精通这一层
    ---------------------------------------------
    网路层： IP协议 封装自己的IP和对方的IP和端口
    ---------------------------------------------
    数据链路层：　进入到硬件（网）
    物理层
