package com.lchy._03Dom4j解析XML的属性;
...
public class Dom4jDemo {
    public static void main(String[] args) throws Exception{
        ...
        //6.获取book元素的全部属性对象
        Attribute attributesSon = book.attribute("desc");
        System.out.println(attributesSon.getName()+"=>"+attributesSon.getValue());

        //7.可以直接获取元素的属性值
        System.out.println(book.attributeValue("id"));
        System.out.println(book.attributeValue("desc"));
    }
}
