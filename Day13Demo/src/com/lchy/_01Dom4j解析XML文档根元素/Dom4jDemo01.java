package com.lchy._01Dom4j解析XML文档根元素;
...
/**
    ...
    dom4j安装步骤：
        ...
        c.在项目中创建一个文件夹:lib
        d.将dom4j-2.1.1.jar文件复制到lib文件夹
        e.在jar文件上点右键，选择Add as Library -> 点OK
        f.在类中导包使用
...
public class Dom4jDemo01 {
    public static void main(String[] args) throws Exception{
        ...
        //这里的“/”是直接去src类路径下寻找
        InputStream inputStream = Dom4jDemo01.class.getResourceAsStream("/books.xml");
