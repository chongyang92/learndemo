package com.lchy._15Collection集合的常用API;
...
public class CollectionDemo {
    public static void main(String[] args) {
        ...
        System.out.println(sets.add("贾乃亮"));
        System.out.println(sets.add("贾乃亮"));
        System.out.println(sets.add("陈羽凡"));
        sets.add("王宝强");
        System.out.println(sets); //集合重写了toString()方法，
        ...
        String[] arrs = sets.toArray(String[]::new);
        ...
        arrayList1.addAll(arrayList2);//把arrayList2集合复制到arrayList
        System.out.println(arrayList1);
    }
}
