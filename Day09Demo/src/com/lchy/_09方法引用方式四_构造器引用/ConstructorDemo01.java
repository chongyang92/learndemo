package com.lchy._09方法引用方式四_构造器引用;
...
public class ConstructorDemo01 {
    public static void main(String[] args) {
        ...
        System.out.println("Object类型数组：" + Arrays.toString(objects));

        //我们想指定转换成字符串类型的数组！
        //最新的写法可以结合构造器引用实现
        //default <T> T[] toArray(IntFunction<T[]> generator)
        lists.toArray(new IntFunction<String[]>() {
            @Override
