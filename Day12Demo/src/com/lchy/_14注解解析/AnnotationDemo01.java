...
public class AnnotationDemo01 {
    ...
    @Test
    public void paraseMethod() throws NoSuchMethodException {
        //1.定位Class类对象
        Class c = BookStore.class;
        //2.定位方法对象
...
@Book(value = "《Java基础到精通》", price = 93.5, authors = {"张三","李四"})
class BookStore{
    @Book(value = "《Mysql基础到精通》", price = 193.5, authors = {"王五","赵六"})
    public void run(){
