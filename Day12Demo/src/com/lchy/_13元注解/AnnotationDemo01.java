...
//@Target({ElementType.METHOD})//声明只能注解方法
//@Target({ElementType.METHOD,ElementType.FIELD})//声明注解方法、属性
@Target({ElementType.METHOD,ElementType.FIELD,ElementType.TYPE})//声明注解方法、属性、类
