...
/**
    ...
    单元测试一般要使用框架进行。
    什么是框架？
            -- 框架是前人或者一些厉害的技术公司在实战或者研发中设计的一些优良的设计方案
    ...
    Junit框架的使用步骤：
        （1）下载这个框架。（别人设计好的技术体系）
            ...
            -- 现在不需要大家去官网下载，因为很多知名框架其实IDEA早就整合好了，
                    程序员可以直接使用。
            Junit已经被IDEA下载好了，可以直接导入到项目使用的。
        （2）直接使用Junit测试代码即可
            a.先模拟业务代码
            b.写测试类
                    测试类的命名规范：以Test开头，以业务类名结尾，使用驼峰命名法
                    业务名称是：UserService
                    测试这个业务类的测试类：TestUserService/UserServiceTest
            c.在测试类中写测试方法
                    测试方法的命名规则：以test开头，以业务方法结尾
    ...
    Junit常用注解（Junit 4.xxxx版本）
        * @Test 测试方法！
        * @Before 用来修饰实例方法，该方法在每一个测试方法之前执行一次。
        * @After 用来修饰实例方法，该方法会在每一个测试方法执行之后执行一次。
        * @BeforeClass 用来修饰静态方法，该方法会在所有测试方法之前只执行一次。
        * @AfterClass 用来修饰静态方法，该方法会在所有测试方法之后只执行一次。

        开始执行的方法：初始化资源。——打开一个文件，读取内容到内存(Map/Array)
        执行完之后的方法：释放资源。——关闭文件。
    Junit常用注解（Junit 5.xxxx版本）
         * @Test 测试方法！
         * @BeforeEach 用来修饰实例方法，该方法在每一个测试方法之前执行一次。
